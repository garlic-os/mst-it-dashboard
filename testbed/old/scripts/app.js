	...
	methods: {
		...
		handleNetdb: function(mode) {
			if (mode == 'search'){
				...
				this.newIframe("Netdb Search", url);
			} else if (mode == 'register') {
				this.newIframe("Netdb Register","https://itweb.mst.edu/auth-cgi-bin/cgiwrap/netdb/register-desktop.pl?owner="+this.netdbRegUser+"&ether=" + this.netdbRegMac);
			}
			this.netdbSearch = "";
			this.netdbRegUser = "";
			this.netdbRegMac = "";
